  ...
  return (
    <div style={{
      ...
      <button
        ...
        onMouseOver={(e) => { e.currentTarget.style.background = '#e67e00'; e.currentTarget.style.transform = 'translateY(-2px)'; }}
        onMouseOut={(e) => { e.currentTarget.style.background = '#FF8C00'; e.currentTarget.style.transform = 'translateY(0)'; }}
      >
        Tekrar Dene
      </button>
    </div>
